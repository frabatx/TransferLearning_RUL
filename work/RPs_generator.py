...
def format_samples(train_samples, test_samples):
    ...
    # resh_train_rect = np.asarray([change_format_rect(rp) for rp in train_samples])
    end = time.time()
...
def main():
    ...
    parser.add_argument('--filter_num', type=int, default=100, required=False,
                        help='Is the percentage of training set returned by the algorithm')
